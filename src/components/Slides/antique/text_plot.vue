...
<template>
  <div class="slide" :style="{ transform: `scale(${scaleFactor})` }">
    <div class="Style1TextPlot content" style="width: 1920px; height: 1080px; position: relative; background: #E5DFC8">
      <div class="Line1"
      ...
      <div
        style="left: 1841px; top: 985px; position: absolute; text-align: center; color: black; font-size: 48px; font-family: Lora; font-weight: 400; line-height: 57.60px; word-wrap: break-word">
        {{ slideIdx + 1 }}</div>
      <div class="Rectangle1"
        style="width: 960px; height: 587px; left: 0px; top: 185px; position: absolute; background: white"></div>
      <div
        contenteditable
        @input="(v) => emit('inputText', (v.target as HTMLElement).innerHTML || 'Text')"
        style="width: 685px; left: 1031px; top: 302px; position: absolute; color: black; font-size: 48px; font-family: Lora; font-weight: 400; line-height: 64.80px; word-wrap: break-word">
        {{ text }}
      </div>
      <div
        contenteditable
        @input="(v) => emit('inputHeader', (v.target as HTMLElement).innerHTML || 'Header')"
        style="left: 1031px; top: 185px; position: absolute; color: black; font-size: 64px; font-family: Lora; font-weight: 400; line-height: 76.80px; word-wrap: break-word">
        {{ header }}</div>
    </div>
  </div>
</template>
