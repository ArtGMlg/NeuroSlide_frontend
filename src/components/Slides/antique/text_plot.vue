...
<template>
  <div class="slide" :style="{ transform: `scale(${scaleFactor})` }">
    <div class="Style1TextPlot content" style="width: 1920px; height: 1080px; position: relative;" :style="{ backgroundColor: color || '#E5DFC8' }">
      <div class="Line1"
      ...
      <div
        ...
        style="width: 685px; left: 1031px; top: 302px; position: absolute; color: black; font-size: 48px; font-weight: 400; line-height: 64.80px; word-wrap: break-word"
        :style="{ fontFamily: font || 'Lora' }"
      >
        {{ text }}
      </div>
      <div
        ...
        style="left: 1031px; top: 185px; position: absolute; color: black; font-size: 64px; font-weight: 400; line-height: 76.80px; word-wrap: break-word"
        :style="{ fontFamily: font || 'Lora' }"
      >
        {{ header }}</div>
    </div>
