...
<template>
  <div class="slide" :style="{ transform: `scale(${scaleFactor})` }">
    <div class="Style1TextPicture content" style="width: 1920px; height: 1080px; position: relative; background: #E5DFC8">
      <div class="Line1"
      ...
      <div
        ...
        style="left: 203px; top: 302px; position: absolute; color: black; font-size: 48px; font-family: Lora; font-weight: 400; line-height: 64.80px; word-wrap: break-word">
        {{ text }}</div>
      <div
        contenteditable
        @input="(v) => emit('inputHeader', (v.target as HTMLElement).innerHTML || 'Header')"
        style="left: 203px; top: 185px; position: absolute; color: black; font-size: 64px; font-family: Lora; font-weight: 400; line-height: 76.80px; word-wrap: break-word">
        {{ header }}</div>
      <img class="Image4"
